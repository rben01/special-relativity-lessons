...
* Relativity of simultaneity: [if two clocks are synchronized in their own frame, and separated by a rest distance $L$ in the direction of their motion, the front clock appears to lag behind the rear clock by $\frac{Lv}{c^2}$ (“leading clocks lag”)]{.fragment}
...
* And, crucially, it preserves the speed of light.

## Conclusion

* We can plot events on a graph with $ct$ on the horizontal axis and $x$ on the vertical axis. Ponder:
   ...
   * In a given frame, simultaneous events lie on a vertical line. What do those same events look like in a frame with relative velocity $v$?
	* In a given frame, co-located events lie on a horizontal line. What do those same events look like in a frame with relative velocity $v$?
