...
* When they return, who is older: the Earth-bound twin (Ernie) or the astronaut twin (Alice)?
...
* So Ernie thinks he ages $\frac{2L}{v}$ during her trip.
...
* On each leg of her trip, Alice says she traveled for $\frac{L}{\gamma v}$.
* Meanwhile, Ernie’s clock is dilated, so on each leg of her trip she sees him age $\frac{L}{\gamma^2 v}$.
* And at the turnaround, she sees him age an additional $\frac{2Lv}{c^2}$.
* So in total she observes him age $2\frac{L}{\gamma^2 v}+\frac{2Lv}{c^2}=\frac{2L}{v}(\frac{1}{\gamma^2}+\frac{v^2}{c^2})=\frac{2L}{v}$!
...
* “Paradoxes” simply are not possible within the theory of relativity.
* If something looks paradoxical, it's probably because you're asking a non-relativistic question to begin with.
* If two observers’ perspectives disagree, it's because they're not looking at two events at the same place at the same time.
