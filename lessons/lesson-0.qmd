...
\nabla\times\vec E&=-\frac{\partial \vec B}{\partial t}&\nabla\times B&=\mu_0\left(\vec J+\varepsilon_0\frac{\partial\vec E}{\partial t}\right)
\end{align*}
$$
:::

* We'll focus on the bottom two. In English: a changing magnetic field creates an electric field, and a changing electric field creates a magnetic field.
...
* Forever!
* We've got an electromagnetic wave!
