...
* If the train has _rest length_ $L$, what will _we_ measure $\Delta t$ to be?
...
* To _them_, _I'm_ moving by at $v$.
...
* Alice starts with Clock A.
* She sends uses wifi (or radio or bluetooth or...) to transmit A’s time to Bob.
...
1. Alice sets Clock A to $-L/c$, but doesn't start it yet.
1. Bob sets Clock B to $0$, but doesn't start it yet.
...
* Subatomic particle similar to the electron except 200x more massive. When observed in the lab, their average lifetime is about $2\,\upmu\textrm{s}$.
* _Secondary muons_ are generated by cosmic rays hitting the atmosphere. They travel at roughly $0.99c$ and can be detected even underground.
* The atmosphere is roughly $100\,\textrm{km}$ thick.
* At this speed, it takes muons roughly $300\,\upmu\textrm{s}$ to travel through the whole atmosphere.
