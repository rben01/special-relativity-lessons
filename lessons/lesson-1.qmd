...
* Galileo and Isaac Newton thought that _one_ of these inertial reference frames was privileged: [that it was the fixed frame relative to which all phenomena could be measured.]{.fragment}
* Einstein disagreed...
...
::: {.notes}
Instructions: start off slowly, 0.1. Gradually increase.
