...
1. No “privileged” frame — we can all claim to be perfectly capable scientists, and all of our observations are as valid as anyone else’s, regardless of our relative motion.
    ...
    * In particular, no two observers can disagree on whether two events are identical. [They may disagree on the coordinates, but not that they're equal: if $(t_A,x_A)=(t_B,x_B)$, then $(t_A',x_A')=(t_B',x_B')$.]{.fragment}
...
::: {.r-stack}
:::: {.fragment}
<object type="image/svg+xml" data="/images/1/light-clock-dynamic.svg" width="400"></object>
::::
:::
