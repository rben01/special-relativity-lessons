...
::: {}
<iframe src="/_astro/lesson-1/light-clocks/InMotion" width="1600" height="500" frameborder="true" ></iframe>
:::
...
<iframe src="/_astro/lesson-1/ComputationOfGamma" width="1600" height="800" frameborder="true" ></iframe>
...
$$
\begin{align}
  t&\class{fragment}{{} =\frac{2l}{c}}\\
  \class{fragment}{l}&\class{fragment}{{} =\frac{ct}{2}}\\\\
  \class{fragment}{\frac{ct'}{2}}&\class{fragment}{{} =\sqrt{l^2+\left(\frac{vt'}{2}\right)^2}}\\
  &\class{fragment}{{} =\sqrt{\frac{c^2t^2}{2^2}+\frac{v^2t'^2}{2^2}}}\\
  \class{fragment}{\frac{c^2t'^2}{2^2}}&\class{fragment}{{} =\frac{c^2t^2}{2^2}+\frac{v^2t'^2}{2^2}}
\end{align}
$$
...
$$
\begin{align}
\frac{c^2t'^2}{2^2}&=\frac{c^2t^2}{2^2}+\frac{v^2t'^2}{2^2}\\
\class{fragment}{c^2t'^2}&\class{fragment}{{}=c^2t^2+v^2t'^2}\\
\class{fragment}{(c^2-v^2)t'^2}&\class{fragment}{{}=c^2t^2}\\
\class{fragment}{t'^2}&\class{fragment}{{}=\frac{c^2}{c^2-v^2}t^2}\\
&\class{fragment}{{}=\frac{1}{1-(v/c)^2}t^2}\\
\class{fragment}{t'}&\class{fragment}{{}=\frac{1}{\sqrt{1-(v/c)^2}}t}\\
\end{align}
$$
...
* Make sure you're comfortable with the derivation of $\gamma$. You may want to run through it again before we meet next week.
  * Feel free to work together!
* (Optional) Compute $\gamma$ for a handful of values of $v$, and use this to explain why we don't observe relativistic effects in our everyday lives.
* Ponder: How can I perceive your clock running slow while you perceive my clock running slow? Isn't this a contradiction? (Two things cannot each be less than each other.)
