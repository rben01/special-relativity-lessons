...
* The correct questions to ask:
	...
	* Or, do the pole and doors smash into each other?
	* Or, do the doors open/close so early/late that they don't even touch the pole?
...
* Since Alice was in sync with Earth when she left, she must perceive $P$’s clock reading far into the future.
...
* And at the turnaround, he ages an additional $\frac{2Lv}{c^2}$.
* So in total she observes him age $\frac{2L}{\gamma^2 v}+\frac{2Lv}{c^2}=\frac{2L}{v}(\frac{1}{\gamma^2}+\frac{v^2}{c^2})$.

## The paradox (quantitative)

$$
\begin{align*}
\frac{v^2}{c^2}&=1-(1-(v/c)^2)\\
&=1-\frac{1}{\gamma^2}\\
