...
* We want to find the times $t_F,t_B$ when the photons reach Frank and Beth from the platform perspective.

## Calculating the time difference

![The positions (𝑥) of Frank, Beth, and their photons over time (𝑡), from the perspective of the platform. Frank and his photon (blue) collide at a later time than Beth and her photon (yellow), indicating that from the platform perspective, the photons do not arrive at the ends of the train simultaneously. The time difference on the platform is indicated by the horizontal distance between the vertical white lines. What would this graph look like from the train’s perspective? What would this graph look like from the platform perspective if rather than traveling at $c$, the photons got a “boost” from the train?](/images/4/simultaneity.svg)
